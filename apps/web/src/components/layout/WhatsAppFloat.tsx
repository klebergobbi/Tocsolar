...
import { buildWhatsAppUrl, readUtmFromLocation } from "@/lib/whatsapp";

export function WhatsAppFloat() {
  // SSR renderiza o link base; após montar, enriquece com UTM da URL.
  const [href, setHref] = useState(() => buildWhatsAppUrl());

  useEffect(() => {
    setHref(buildWhatsAppUrl({ utm: readUtmFromLocation() }));
  }, []);
